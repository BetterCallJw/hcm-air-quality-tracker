...
def fetch_and_log_air_quality():
    ...
    # 2. Call API
    url = f"https://air-quality-api.open-meteo.com/v1/air-quality?latitude={latitude}&longitude={longitude}&hourly=pm2_5,european_aqi&start_date={yesterday}&end_date={yesterday}"
    ...
    try:
        ...
        print(f"Đã cập nhật thành công dữ liệu ngày {yesterday}")
